...
public class ParcelProblem {
    ...
    public void setContainer(int x_size, int y_size, int z_size) {
        ...
        this.positioning = new Parcel[x_size][y_size][z_size];
    }
...
//                System.out.println("ERROR: Parcels overlap in coordinate " + coordinate);
    ...
    public void addParcelToSubset(int x_size, int y_size, int z_size, int value) {
        this.parcelSubset.add(new Parcel(x_size, y_size, z_size, value));
    }
